 ...
 * List< ? extends X > doesn't allow to add anything, except for null into the list.<br>
 * List< ? super X > allows to add anything that is-a X (X or its subtype), or null.<br><br>
 * 
 * Getting an item from the list:<br>
 * When you get an item from List< ? extends X >, you can assign it to a variable of type X or any supertype of X, including Object.<br>
 *
 * When you get an item from List< ? super X >, you can only assign it to a variable of type Object.<br>
 * 
 * @author sitapsha
 *
 */
